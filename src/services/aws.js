...
module.exports = {
    IAM_USER_KEY: 'AKIA2B53JENXH3YR4LF6',
    IAM_USER_SECRET: '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',
    BUCKET_NAME: 'salao-develop',
            ...
            s3bucket.createBucket(function(){
                s3bucket.deleteBucket(
                    ...
                    function(err, data){
                        ...
                        console.log(data);
                        return resolve({ error : fales , message : data});
                    }
                );
            });
        });
